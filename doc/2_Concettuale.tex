...
\\L’identificatore alternativo (Utente, nomeRicetta) verrà successivamente espresso come vincolo UNIQUE in fase di progettazione logica, in modo tale modellare correttamente il vincolo di dominio secondo il quale un \textbf{utente} non può pubblicare ricette omonime.
